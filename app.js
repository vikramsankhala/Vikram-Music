(function () {
  const CATEGORY_KEYS = ['celine', 'shakira', 'enrique', 'dance', 'classics', 'football', 'pele', 'maradona', 'messi', 'messigear', 'ronaldo', 'cruyff', 'zidane', 'ronaldinho', 'r9', 'vanbasten', 'beckenbauer', 'oscar_songs', 'musical_films', 'classic_themes', 'movie_dance', 'romantic_moments', 'web_series', 'hindi_web_series', 'hindi_movies', 'bengali_movies', 'malayalam_movies', 'tt_gear', 'tt_players', 'tt_legends', 'tt_styles', 'tt_matches', 'tennis_aces', 'tennis_dtl', 'tennis_crosscourt', 'tennis_single_dtl', 'tennis_single_crosscourt', 'bike_secondhand', 'bike_customization', 'bike_enhancements', 'bike_gear', 'bike_repairs', 'playlist', 'love', 'african', 'latin', 'flamenco'];
  const BADGE_MAP = {
